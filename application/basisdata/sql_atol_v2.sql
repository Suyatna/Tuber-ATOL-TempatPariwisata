...
CREATE TABLE `tb_admin` (
  ...
  `akses_wilayah` enum('KOTA BANDUNG','KABUPATEN BANDUNG','KABUPATEN BANDUNG BARAT','KOTA CIMAHI') NOT NULL,
  PRIMARY KEY (`nip`)
