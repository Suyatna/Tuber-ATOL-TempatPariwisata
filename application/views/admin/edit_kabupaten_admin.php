                    ...
                    <div class="section">
                        ...
                        <div id="basic-form" class="section">
                            <div id="table-datatables">
                                <h4 class="header">Update Kabupaten</h4>
                                <hr>
                                <div class="row">
                                    <div class="col s12 m12 l12">
                                        <div class="card-panel">
                                            <div class="row">
                                                ...
                                                <form class="col s12" action="<?php echo base_url() .'update_kabupaten_admin'; ?>" method="POST">
                                                
                                                    <div class="row">
                                                        <div class="input-field col s12">
                                                            <input id="" name="id_kabupaten" type="text" value="<?php echo $id_kabupaten; ?>" required readonly> 
                                                    ...
                                                    <div class="row">
                                                        <div class="input-field col s12">
                                                            <button class="btn cyan waves-effect waves-light" type="submit" name="action">Update
