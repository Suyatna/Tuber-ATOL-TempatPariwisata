                    ...
                    <div class="section">
                        ...
                        <div id="basic-form" class="section">
                            <div id="table-datatables">
                                <h4 class="header">Edit Tempat Wisata</h4>
                                <hr>
                                <div class="row">
                                    <div class="col s12 m12 l12">
                                        <div class="card-panel">
                                            <div class="row">
                                                ...
                                                <form class="col s12" action="<?php echo base_url() .'update_wisata_admin'; ?>" method="POST">
    ...
    <script>        
        $(document).ready(function(){
            ...
            $("select#data-kabupaten").change(function() {
                ...
                $.ajax({
                    url:'<?php echo base_url() ?>api/kecamatan/'+idKabupaten,
                    method: 'GET',
                    dataType: 'json'
            ...
            $("select#data-kecamatan").change(function() {
                ...
                $.ajax({
                    url:'<?php echo base_url() ?>api/kelurahan/'+idKecamatan,
                    method: 'GET',
                    dataType: 'json'
                }).done(function(response) {
